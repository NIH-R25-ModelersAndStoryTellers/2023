...
In this lecture, we take the narrow sense of statistical/machine learning for the model step. 
...
We use the phrases **statistical learning**, **machine learning**, or simply **learning** interchangeably.
...
- **Unsupervised learning**: no output. We learn relationships and structure in the data. 
    - Clustering. [Example: geodemographic clustering](https://nih-r25-modelersandstorytellers.github.io/2023/data-science-tutorials/08-modeling/08-modeling.html#geodemographic-clustering)   
    - Dimension reduction. [Example: PCA with socio-demographic characteristics ](https://nih-r25-modelersandstorytellers.github.io/2023/data-science-tutorials/08-modeling/08-modeling.html#pca) 
...
# Import Wage data
Wage = DataFrame(CSV.File("Wage.csv"))
...
<script type="text/javascript" src="https://ssl.gstatic.com/trends_nrtr/3197_RC01/embed_loader.js"></script> <script type="text/javascript"> trends.embed.renderExploreWidget("TIMESERIES", {"comparisonItem":[{"keyword":"chatgpt","geo":"","time":"2022-07-24 2023-07-24"}],"category":0,"property":""}, {"exploreQuery":"q=chatgpt&date=today 12-m","guestPath":"https://trends.google.com:443/trends/embed/"}); </script>
...
<p align="center">
![](ai-mask.JPG){width=50%}
</p>

## A Brief History of Statistical/Machine Learning
...
- Unsupervised learning: clustering (k-means, hierarchical, spectral), PCA, t-SNE, UMAP, CCA, ICA, neural network (auto encoder).
