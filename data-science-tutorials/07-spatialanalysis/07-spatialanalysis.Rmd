...
description: >
  Chapter 7 of the book [Analyzing US Census Data](https://walker-data.com/census-r/the-united-states-census-and-the-r-programming-language.html).
---
...
times <- mb_matrix(
  origins = lametro_tracts, 
  destinations = lametro_trauma,
  profile = "driving"
  )
...
### Cachement areas: buffers and isochrones
